...
public class Simulador_Chamada extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simulador__chamada);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.btn_ligar:
                    ...
                    if(ActivityCompat.checkSelfPermission(Simulador_Chamada.this,
                            Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){

                        ActivityCompat.requestPermissions(Simulador_Chamada.this, new String[]{Manifest.permission.CALL_PHONE}, 0);
